...
file_element.onchange = function(){
    ...
    else
    {
        ...
        ajax_request.addEventListener('load', function(event){
            ...
            uploaded_image.innerHTML = '<div class="alert alert-success">Files Uploaded Successfully</div><img style="width:50%;" src="'+file_data.image_path+'" class="img-fluid img-thumbnail" />';
